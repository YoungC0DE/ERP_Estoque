...
<p>Retorna uma lista de produtos cadastrados.</p>
<p>Quando <code>pagination=false</code>, retorna uma lista simples (máximo 20 produtos) sem paginação.
Quando não enviado ou <code>pagination=true</code>, retorna dados paginados (padrão: 15 por página).</p>
<p>É possível realizar uma busca utilizando o parâmetro <code>search</code>,
que será aplicado no campo <code>nome</code>.</p>
<p>Exemplo:</p>
<ul>
<li>/products (paginado)</li>
<li>/products?pagination=false (sem paginação, máx 20)</li>
<li>/products?search=notebook</li>
<li>/products?search=notebook&amp;pagination=false</li>
</ul>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/produtos?pagination=false&amp;search=notebook&amp;page=1&amp;per_page=15" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="pagination"                data-endpoint="GETapi-v1-produtos"
               value="false"
               data-component="query">
    <br>
<p>Opcional. Se false, retorna dados sem paginação (máx 20). Default: true. Example: <code>false</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="query">
    <br>
<p>Opcional. Termo para busca por nome do produto. Example: <code>notebook</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="query">
    <br>
<p>Opcional. Página (apenas com pagination=true). Example: <code>1</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="query">
    <br>
<p>Opcional. Itens por página (apenas com pagination=true). Default: 15. Example: <code>15</code></p>
            </div>
                </form>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;current_page&quot;: 1,
    &quot;data&quot;: [],
    &quot;first_page_url&quot;: &quot;http://localhost/api/v1/compras?page=1&quot;,
    &quot;from&quot;: null,
    &quot;last_page&quot;: 1,
    &quot;last_page_url&quot;: &quot;http://localhost/api/v1/compras?page=1&quot;,
    &quot;links&quot;: [
        {
            &quot;url&quot;: null,
        ...
        {
            &quot;url&quot;: &quot;http://localhost/api/v1/compras?page=1&quot;,
            &quot;label&quot;: &quot;1&quot;,
            &quot;page&quot;: 1,
            &quot;active&quot;: true
        },
    ...
    &quot;next_page_url&quot;: null,
    &quot;path&quot;: &quot;http://localhost/api/v1/compras&quot;,
    &quot;per_page&quot;: 15,
    &quot;prev_page_url&quot;: null,
    &quot;to&quot;: null,
    &quot;total&quot;: 0
...
<code class="language-json" style="max-height: 300px;">{
    &quot;current_page&quot;: 1,
    &quot;data&quot;: [],
    &quot;first_page_url&quot;: &quot;http://localhost/api/v1/vendas?page=1&quot;,
    &quot;from&quot;: null,
    &quot;last_page&quot;: 1,
    &quot;last_page_url&quot;: &quot;http://localhost/api/v1/vendas?page=1&quot;,
    &quot;links&quot;: [
        {
            &quot;url&quot;: null,
            &quot;label&quot;: &quot;&amp;laquo; Previous&quot;,
        ...
        {
            &quot;url&quot;: &quot;http://localhost/api/v1/vendas?page=1&quot;,
            &quot;label&quot;: &quot;1&quot;,
            &quot;page&quot;: 1,
            &quot;active&quot;: true
        },
    ...
    &quot;next_page_url&quot;: null,
    &quot;path&quot;: &quot;http://localhost/api/v1/vendas&quot;,
    &quot;per_page&quot;: 15,
    &quot;prev_page_url&quot;: null,
    &quot;to&quot;: null,
    &quot;total&quot;: 0
